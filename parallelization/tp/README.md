...
| (feed_forward)       |               |             |                         |                      |               |             |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
| feed_forward.w1      | [4, 512, 768] | Replicate() | [2048, 768]             | None                 | [4, 512, 1024]| Shard(-1)   |
| (Linear)             |               |             | Per rank: [1024, 768]   | (local matmul)       |               |             |
|                      |               |             | Shard(0) on out         |                      |               |             |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
| feed_forward.w3      | [4, 512, 768] | Replicate() | [2048, 768]             | None                 | [4, 512, 1024]| Shard(-1)   |
| (Linear)             |               |             | Per rank: [1024, 768]   | (local matmul)       |               |             |
|                      |               |             | Shard(0) on out         |                      |               |             |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
| SiLU & Element-wise *| [4, 512, 1024]| Shard(-1)   | -                       | None                 | [4, 512, 1024]| Shard(-1)   |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
| feed_forward.w2      | [4, 512, 1024]| Shard(-1)   | [768, 2048]             | Reduce-scatter       | [4, 256, 768] | Shard(1)    |
| (Linear)             |               |             | Per rank: [768, 1024]   |                      |               |             |
|                      |               |             | Shard(1) on in          |                      |               |             |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
| Residual add         | [4, 256, 768] | Shard(1)    | -                       | None                 | [4, 256, 768] | Shard(1)    |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
| norm (final)         | [4, 256, 768] | Shard(1)    | [768] weights           | None                 | [4, 256, 768] | Shard(1)    |
|                      |               |             | Replicate()             |                      |               |             |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
| output (logits)      | [4, 256, 768] | Shard(1)    | [32000, 768]            | 1. All-gather (inp)  | [4, 512, 32000]| Replicate() |
| (ColwiseLinear)      |               |             | Per rank: [16000, 768]  | 2. All-gather (out)  |               |             |
|                      |               |             | Shard(0) on vocab       |                      |               |             |
+----------------------+---------------+-------------+-------------------------+----------------------+---------------+-------------+
```
